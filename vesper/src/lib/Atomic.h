...
/**
* Naive C++ wrapper around atomic_ops library.
*
* Leave HP library for now and use gcc atomic builtins (gcc 4.1+).
* GCC builtins are implemented only on x86? Check.
*
* See http://lists.boost.org/Archives/boost/2006/11/113380.php for ideas
