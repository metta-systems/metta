...
static char * dumpBstring (const struct tagbstring * b) {
	...
	if (dumpOut[rot] == NULL) {
		...
		if (dumpOut[rot] == NULL) return (char *)"FATAL INTERNAL ERROR";
	}
	dumpOut[rot]->slen = 0;
	if (b == NULL) {
...
static int test7x8_0 (const char * fnname, int (* fnptr) (const struct tagbstring *, const struct tagbstring *), const struct tagbstring * b0, const struct tagbstring * b1, int res) {
int rv, ret = 0;
...
static int test7x8 (const char * fnname, int (* fnptr) (const struct tagbstring *, const struct tagbstring *),
...
static int test15_0 (bstring b0, int pos, const_bstring b1, unsigned char fill, const char * res) {
bstring b2;
...
static int test16_0 (bstring b0, int pos, const_bstring b1, unsigned char fill, const char * res) {
bstring b2;
int rv, ret = 0;
...
static int test17_0 (bstring s1, int pos, int len, const char * res) {
bstring b2;
int rv, ret = 0;
...
static int test26_0 (bstring b0, int pos, int len, const_bstring b1, unsigned char fill, const char * res) {
bstring b2;
int rv, ret = 0;
...
static int test29_0 (bstring b0, const char * s, const char * res) {
bstring b2;
int rv, ret = 0;
...
static int test31_0 (bstring b0, const_bstring find, const_bstring replace, int pos, const char * res) {
bstring b2;
int rv, ret = 0;
...
static int test31_1 (bstring b0, const_bstring find, const_bstring replace, int pos, const char * res) {
bstring b2;
int rv, ret = 0;
