...
extern "C"
{
    ...
    void activate_idt(address_t base); // in loader.s
}
...
void interrupt_descriptor_table::install()
{
    ...
    idt_entries[3].set(CS_SEL, isr3, idt_entry::trap, 3);
    idt_entries[4].set(CS_SEL, isr4, idt_entry::trap, 3);
    ...
    // nothing defined on intel below this line
