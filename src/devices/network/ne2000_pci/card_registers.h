...
enum {
	...
	// the mysteriously undocumented
	DATA_PORT_BANK012_RW = 0x10
};
...
enum {
	...
	INTERRUPT_STATUS_CLEAR_ALL = 0xff
};
...
enum {
	...
	INTERRUPT_MASK_ENABLE_ALL = 0x3f,
	INTERRUPT_MASK_ENABLE_ALL_EXCEPT_RECEIVE = 0x3a
};
